...
export const TextToSpeech = () => {
	...
	const speak = (username: string) => {
		...
		const utterance = new SpeechSynthesisUtterance(
			`Welcome to my portfolio ${username}.... As a full stack developer, I  specialize in creating visually stunning projects using cutting-edge technologies such as React and Three.js .... I am a keeen learner and I am free to learn more technologies which are beneficial for me and my team `
		);
		utterance.rate = 0.2;
